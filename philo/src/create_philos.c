...
/*   Updated: 2026/01/27 10:58:16 by hal-lawa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philosopher.h"

t_thread_args	*init_thread_args(t_philo *philo, int i, pthread_mutex_t *forks,
...
void	*free_args_philo(t_thread_args *args, t_philo_data *philo_data,
		pthread_t *philos)
{
